...
Let's begin with a simple **Barrel**. Place it in the world as usual, and then &6right click it with the **Basic Tier Upgrade**.

Now, once you enter the inventory, you'll see some new additions.

The slot to the left *accepts upgrades* which allow your storage to perform certain functions.
