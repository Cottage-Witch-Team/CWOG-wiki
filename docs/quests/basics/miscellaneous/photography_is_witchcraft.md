...
You, too, can *capture photos with a camera*! ==Right click== the camera to enter photo mode. From here, you can ==crouch== to access the *photo settings* - Focal Length, Shutter Speed, Flash Mode, and Composition Guides.

But first, you'll need some **Film**, and you can also upgrade your camera with *other items*!
...
- **Redstone Lamp** to add a *flash*
- **Spyglass** to add a *zoom*
