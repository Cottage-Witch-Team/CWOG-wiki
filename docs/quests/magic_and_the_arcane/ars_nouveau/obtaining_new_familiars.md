...
You must ==place a Ritual Brazier== nearby the Familiar and ==put the **Tablet of Binding&6 on it**. Then &6right click== the Brazier. It will ensnare the **Familiar** and produce a **Bound Script**, which you can then ==right click== to learn - from then on, that Familiar may be summoned from the *third tab in your spellbook*!
